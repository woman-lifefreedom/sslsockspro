...
public class KeyEditActivity extends AppCompatActivity {
	...
	private void importExternalFile() {
		...
		importFileRequestLauncher.launch(Intent.createChooser(intent, getString(R.string.title_activity_key_create)));
	}
	...
	private void saveFile() {
		...
		if (!fileNameString.endsWith(".pem") && !fileNameString.endsWith(".p12")) {
			Toast.makeText(this, R.string.keyfile_name_ext, Toast.LENGTH_SHORT).show();
			return;
		}
